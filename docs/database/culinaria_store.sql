...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2026 a las 03:08:47
...
--
-- Base de datos: `culinaria_store`
--
CREATE DATABASE IF NOT EXISTS `culinaria_store` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `culinaria_store`;
...
--
ALTER TABLE `detalle_venta`
  ADD CONSTRAINT `fk_detalle_productos` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`),
  ADD CONSTRAINT `fk_detalle_ventas` FOREIGN KEY (`id_pedido`) REFERENCES `ventas` (`id_pedido`);
